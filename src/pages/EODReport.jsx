...
import Sidebar from '../components/AgentDashboard/Sidebar'; // Assuming this is the correct path
...
const EODReport = () => {
    ...
    // 3. REMOVED the old useEffect hook that used alert()
    ...
    const handleSubmit = () => {
        if (validateForm()) { // Fixed typo here (was validate.form)
            console.log("Form is valid! Submitting...");
            alert("EOD Report Submitted Successfully! (This is a placeholder)");
        } else {
    ...
    return (
        <div className={styles.dashboardContainer}>
            {/* 4. ADD the modal component to be rendered */}
            {isModalOpen && <BetaWarningModal onClose={() => setIsModalOpen(false)} />}
            
            <Sidebar onLogout={handleLogout} />
            <main className={styles.mainContent}>
                <div className={styles.pageHeader}>
                    <h1>Agent End of Day Report</h1>
                </div>

                {/* Top section for data paste and verification table */}
                ...
                {/* Bottom grid for summaries and manual entry */}
                    ...
                    <div className={styles.bottomGrid}>
                        ...
                        <div className={styles.entryColumn}>
                            <div className={styles.card}>
                                ...
                                <button onClick={handleSubmit} className={styles.submitButton}>Submit EOD Report</button>
                            </div>
                        </div>
                    </div>
                 )}
